...
//template <>
//class SelectObjectsPropertyFactory<SelectObjectsPropertyManager> : public QtAbstractEditorFactory<SelectObjectsPropertyManager>, public MyQObject
//{
//
//	Q_OBJECT
//
...
//protected:
//
//	void connectPropertyManager(SelectObjectsPropertyManager* manager);
//
//	QWidget* createEditor(SelectObjectsPropertyManager* manager, QtProperty* property, QWidget* parent);
//
//	void disconnectPropertyManager(SelectObjectsPropertyManager* manager);
//
//signals:
//
//	void ObjectsSelectedUpdate(QList<QTreeWidgetItem*> selectedItems);
...
//		(MyQObject*)this, SLOT(slotPropertyChanged(QtProperty*, const QList<QTreeWidgetItem*>&)));
//}
//
...
//		(MyQObject*)this, SLOT(slotSetValue(const QList<QTreeWidgetItem*>&)));
//	QObject::connect(widget, SIGNAL(destroyed(QObject*)),
//		(MyQObject*)this, SLOT(slotWidgetDestroyed(QObject*)));
//	QObject::connect(widget, SIGNAL(ObjectsSelectedUpdate(QList<QTreeWidgetItem*>)),
//		(MyQObject*)this, SIGNAL(ObjectsSelectedUpdate(QList<QTreeWidgetItem*>)));
//	return widget;
//}
//
