...
template<class Cmpt>
inline AutLib::DiagTensor<Cmpt>::DiagTensor()
{}

template<class Cmpt>
inline AutLib::DiagTensor<Cmpt>::DiagTensor(const VectorSpace<DiagTensor<Cmpt>, Cmpt, 3>& vs)
...
template<class Cmpt>
inline AutLib::DiagTensor<Cmpt>::DiagTensor(Istream & is)
	: VectorSpace<DiagTensor<Cmpt>, Cmpt, 3>(is)
{}

template<class Cmpt>
inline const Cmpt & AutLib::DiagTensor<Cmpt>::xx() const
{
	return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt & AutLib::DiagTensor<Cmpt>::yy() const
{
	return this->v_[YY];
}

template<class Cmpt>
inline const Cmpt & AutLib::DiagTensor<Cmpt>::zz() const
{
	return this->v_[ZZ];
}

template<class Cmpt>
inline Cmpt & AutLib::DiagTensor<Cmpt>::xx()
{
	return this->v_[XX];
}

template<class Cmpt>
inline Cmpt & AutLib::DiagTensor<Cmpt>::yy()
{
	return this->v_[YY];
}

template<class Cmpt>
inline Cmpt & AutLib::DiagTensor<Cmpt>::zz()
{
	return this->v_[ZZ];
}
...
namespace AutLib
{
	...
	template <class Cmpt>
	inline Tensor<Cmpt> operator+(const DiagTensor<Cmpt>& dt1, const Tensor<Cmpt>& t2)
	{
		return Tensor<Cmpt>
			(
	...
	template <class Cmpt>
	inline Tensor<Cmpt> operator+(const Tensor<Cmpt>& t1, const DiagTensor<Cmpt>& dt2)
	{
		return Tensor<Cmpt>
			(
	...
	template <class Cmpt>
	inline DiagTensor<Cmpt> operator&(const DiagTensor<Cmpt>& dt1, const DiagTensor<Cmpt>& dt2)
	{
	...
	template <class Cmpt>
	inline Vector<Cmpt> operator&(const DiagTensor<Cmpt>& dt, const Vector<Cmpt>& v)
	{
		return Vector<Cmpt>
			(
				dt.xx()*v.x(),
	...
	template <class Cmpt>
	inline Vector<Cmpt> operator&(const Vector<Cmpt>& v, const DiagTensor<Cmpt>& dt)
	{
		return Vector<Cmpt>
			(
				v.x()*dt.xx(),
	...
	template <class Cmpt>
	inline DiagTensor<Cmpt> operator/(const scalar s, const DiagTensor<Cmpt>& dt)
	{
	...
	public:
		...
		typedef DiagTensor<Cmpt> type;
	};

	template<class Cmpt>
	class outerProduct<DiagTensor<Cmpt>, Cmpt>
	{
	public:
