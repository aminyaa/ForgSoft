...
template<class Cmpt>
inline AutLib::SymmTensor<Cmpt>::SymmTensor()
{}

template<class Cmpt>
inline AutLib::SymmTensor<Cmpt>::SymmTensor(const VectorSpace<SymmTensor<Cmpt>, Cmpt, 6>& vs)
	: VectorSpace<SymmTensor<Cmpt>, Cmpt, 6>(vs)
{}

template<class Cmpt>
inline AutLib::SymmTensor<Cmpt>::SymmTensor(const SphericalTensor<Cmpt>& st)
{
...
template<class Cmpt>
inline AutLib::SymmTensor<Cmpt>::SymmTensor(Istream & is)
	: VectorSpace<SymmTensor<Cmpt>, Cmpt, 6>(is)
{}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::xx() const
{
	return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::xy() const
{
	return this->v_[XY];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::xz() const
{
	return this->v_[XZ];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::yy() const
{
	return this->v_[YY];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::yz() const
{
	return this->v_[YZ];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor<Cmpt>::zz() const
{
	return this->v_[ZZ];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::xx()
{
	return this->v_[XX];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::xy()
{
	return this->v_[XY];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::xz()
{
	return this->v_[XZ];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::yy()
{
	return this->v_[YY];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::yz()
{
	return this->v_[YZ];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor<Cmpt>::zz()
{
	return this->v_[ZZ];
}

template<class Cmpt>
inline const AutLib::SymmTensor<Cmpt>& AutLib::SymmTensor<Cmpt>::T() const
{
	return *this;
}
...
namespace AutLib
{
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SymmTensor<Cmpt>& st1, const SymmTensor<Cmpt>& st2)
	{
		return
			(
	...
	template<class Cmpt>
	inline Vector<Cmpt> operator&(const SymmTensor<Cmpt>& st, const Vector<Cmpt>& v)
	{
		return Vector<Cmpt>
			(
	...
	template<class Cmpt>
	inline Vector<Cmpt> operator&(const Vector<Cmpt>& v, const SymmTensor<Cmpt>& st)
	{
		return Vector<Cmpt>
			(
	...
	template<class Cmpt>
	inline SymmTensor<Cmpt> innerSqr(const SymmTensor<Cmpt>& st)
	{
	...
	template<class Cmpt>
	inline SymmTensor<Cmpt> operator+(const SphericalTensor<Cmpt>& spt1, const SymmTensor<Cmpt>& st2)
	{
		return SymmTensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline SymmTensor<Cmpt> operator+(const SymmTensor<Cmpt>& st1, const SphericalTensor<Cmpt>& spt2)
	{
		return SymmTensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SphericalTensor<Cmpt>& spt1, const SymmTensor<Cmpt>& st2)
	{
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SymmTensor<Cmpt>& st1, const SphericalTensor<Cmpt>& spt2)
	{
