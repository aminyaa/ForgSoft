...
template<class Cmpt>
inline AutLib::SymmTensor2D<Cmpt>::SymmTensor2D()
{}

template<class Cmpt>
inline AutLib::SymmTensor2D<Cmpt>::SymmTensor2D(const VectorSpace<SymmTensor2D<Cmpt>, Cmpt, 3>& vs)
	: VectorSpace<SymmTensor2D<Cmpt>, Cmpt, 3>(vs)
{}

template<class Cmpt>
inline AutLib::SymmTensor2D<Cmpt>::SymmTensor2D(const SphericalTensor2D<Cmpt>& st)
{
	this->v_[XX] = st.ii(); 
	this->v_[XY] = 0;
	this->v_[YY] = st.ii();
...
template<class Cmpt>
inline AutLib::SymmTensor2D<Cmpt>::SymmTensor2D(Istream & is)
	: VectorSpace<SymmTensor2D<Cmpt>, Cmpt, 3>(is)
{}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor2D<Cmpt>::xx() const
{
	return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor2D<Cmpt>::xy() const
{
	return this->v_[XY];
}

template<class Cmpt>
inline const Cmpt & AutLib::SymmTensor2D<Cmpt>::yy() const
{
	return this->v_[YY];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor2D<Cmpt>::xx()
{
	return this->v_[XX];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor2D<Cmpt>::xy()
{
	return this->v_[XY];
}

template<class Cmpt>
inline Cmpt & AutLib::SymmTensor2D<Cmpt>::yy()
{
	return this->v_[YY];
}

template<class Cmpt>
inline const AutLib::SymmTensor2D<Cmpt>& AutLib::SymmTensor2D<Cmpt>::T() const
{
	return *this;
}
...
namespace AutLib
{
	...
	template<class Cmpt>
	inline Tensor2D<Cmpt> operator&(const SymmTensor2D<Cmpt>& st1, const SymmTensor2D<Cmpt>& st2)
	{
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SymmTensor2D<Cmpt>& st1, const SymmTensor2D<Cmpt>& st2)
	{
		return
			(
	...
	template<class Cmpt>
	inline Vector2D<Cmpt> operator&(const SymmTensor2D<Cmpt>& st, const Vector2D<Cmpt>& v)
	{
	...
	template<class Cmpt>
	inline Vector2D<Cmpt> operator&(const Vector2D<Cmpt>& v, const SymmTensor2D<Cmpt>& st)
	{
		return Vector2D<Cmpt>
			(
				v.x()*st.xx() + v.y()*st.xy(),
	...
	template<class Cmpt>
	inline SymmTensor2D<Cmpt> innerSqr(const SymmTensor2D<Cmpt>& st)
	{
	...
	template<class Cmpt>
	inline SymmTensor2D<Cmpt> operator+(const SphericalTensor2D<Cmpt>& spt1, const SymmTensor2D<Cmpt>& st2)
	{
		return SymmTensor2D<Cmpt>
			(
	...
	template<class Cmpt>
	inline SymmTensor2D<Cmpt> operator+(const SymmTensor2D<Cmpt>& st1, const SphericalTensor2D<Cmpt>& spt2)
	{
		return SymmTensor2D<Cmpt>
			(
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SphericalTensor2D<Cmpt>& spt1, const SymmTensor2D<Cmpt>& st2)
	{
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SymmTensor2D<Cmpt>& st1, const SphericalTensor2D<Cmpt>& spt2)
	{
