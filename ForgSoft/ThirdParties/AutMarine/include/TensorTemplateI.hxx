...
template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor()
{}

template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor(const VectorSpace<Tensor<Cmpt>, Cmpt, 9>& vs)
	: VectorSpace<Tensor<Cmpt>, Cmpt, 9>(vs)
{}

template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor(const SphericalTensor<Cmpt>& st)
{
	this->v_[XX] = st.ii(); 
	this->v_[XY] = 0; 
	this->v_[XZ] = 0;
...
template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor(const SymmTensor<Cmpt>& st)
{
	this->v_[XX] = st.xx(); 
	this->v_[XY] = st.xy();
	this->v_[XZ] = st.xz();
...
template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor(const Vector<Vector<Cmpt>>& tr)
{
	this->v_[XX] = tr.x().x();
	this->v_[XY] = tr.x().y();
	this->v_[XZ] = tr.x().z();
...
template<class Cmpt>
inline AutLib::Tensor<Cmpt>::Tensor(Istream & is)
	: VectorSpace<Tensor<Cmpt>, Cmpt, 9>(is)
{}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::xx() const
{
	return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::xy() const
{
	return this->v_[XY];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::xz() const
{
	return this->v_[XZ];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::yx() const
{
	return this->v_[YX];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::yy() const
{
	return this->v_[YY];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::yz() const
{
	return this->v_[YZ];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::zx() const
{
	return this->v_[ZX];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::zy() const
{
	return this->v_[ZY];
}

template<class Cmpt>
inline const Cmpt & AutLib::Tensor<Cmpt>::zz() const
{
	return this->v_[ZZ];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::xx()
{
	return this->v_[XX];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::xy()
{
	return this->v_[XY];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::xz()
{
	return this->v_[XZ];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::yx()
{
	return this->v_[YX];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::yy()
{
	return this->v_[YY];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::yz()
{
	return this->v_[YZ];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::zx()
{
	return this->v_[ZX];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::zy()
{
	return this->v_[ZY];
}

template<class Cmpt>
inline Cmpt & AutLib::Tensor<Cmpt>::zz()
{
	return this->v_[ZZ];
}

template<class Cmpt>
inline AutLib::Vector<Cmpt> AutLib::Tensor<Cmpt>::x() const
{
	return Vector<Cmpt>(this->v_[XX], this->v_[XY], this->v_[XZ]);
}

template<class Cmpt>
inline AutLib::Vector<Cmpt> AutLib::Tensor<Cmpt>::y() const
{
	return Vector<Cmpt>(this->v_[YX], this->v_[YY], this->v_[YZ]);
}

template<class Cmpt>
inline AutLib::Vector<Cmpt> AutLib::Tensor<Cmpt>::z() const
{
	return Vector<Cmpt>(this->v_[ZX], this->v_[ZY], this->v_[ZZ]);
}

template<class Cmpt>
inline AutLib::Vector<Cmpt> AutLib::Tensor<Cmpt>::vectorComponent(const direction cmpt) const
{
	switch (cmpt)
	{
	case 0:
...
{
	template<class Cmpt>
	inline const Cmpt & Tensor<Cmpt>::operator()(const direction i, const direction j) const
	{
		return this->operator[](i*Tensor<Cmpt>::dim + j);
	}

	template<class Cmpt>
	inline Cmpt & AutLib::Tensor<Cmpt>::operator()(const direction i, const direction j)
	{
		return this->operator[](i*Tensor<Cmpt>::dim + j);
	}
}
...
template<class Cmpt>
inline AutLib::Tensor<Cmpt> AutLib::Tensor<Cmpt>::T() const
{
	return Tensor<Cmpt>
		(
			xx(), yx(), zx(),
...
namespace AutLib
{
	...
	template<class Cmpt>
	inline void AutLib::Tensor<Cmpt>::operator=(const Vector<Vector<Cmpt>>& tr)
	{
		this->v_[XX] = tr.x().x();
		this->v_[XY] = tr.x().y();
		this->v_[XZ] = tr.x().z();
...
namespace AutLib
{
	...
	template<class Cmpt>
	inline typename innerProduct<Tensor<Cmpt>, Tensor<Cmpt> >::type operator&(const Tensor<Cmpt>& t1, const Tensor<Cmpt>& t2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline typename innerProduct<Tensor<Cmpt>, Vector<Cmpt> >::type operator&(const Tensor<Cmpt>& t, const Vector<Cmpt>& v)
	{
		return Vector<Cmpt>
			(
	...
	template<class Cmpt>
	inline typename outerProduct<Vector<Cmpt>, Vector<Cmpt> >::type operator*(const Vector<Cmpt>& v1, const Vector<Cmpt>& v2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Tensor<Cmpt> operator+(const SphericalTensor<Cmpt>& st1, const Tensor<Cmpt>& t2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Tensor<Cmpt> operator+(const Tensor<Cmpt>& t1, const SphericalTensor<Cmpt>& st2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SphericalTensor<Cmpt>& st1, const Tensor<Cmpt>& t2)
	{
	...
	template<class Cmpt>
	inline Cmpt operator&&(const Tensor<Cmpt>& t1, const SphericalTensor<Cmpt>& st2)
	{
	...
	template<class Cmpt>
	inline Tensor<Cmpt> operator+(const SymmTensor<Cmpt>& st1, const Tensor<Cmpt>& t2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Tensor<Cmpt> operator+(const Tensor<Cmpt>& t1, const SymmTensor<Cmpt>& st2)
	{
		return Tensor<Cmpt>
			(
	...
	template<class Cmpt>
	inline Cmpt operator&&(const SymmTensor<Cmpt>& st1, const Tensor<Cmpt>& t2)
	{
		return
			(
				st1.xx()*t2.xx() + st1.xy()*t2.xy() + st1.xz()*t2.xz() +
	...
	template<class Cmpt>
	inline Cmpt operator&&(const Tensor<Cmpt>& t1, const SymmTensor<Cmpt>& st2)
	{
		return
			(
				t1.xx()*st2.xx() + t1.xy()*st2.xy() + t1.xz()*st2.xz() +
