...
namespace AutLib
{
	...
	struct Vessel_FormDim_Profiles
	{

		Handle(Geom2d_Curve) StationAreaProfile;
		Handle(Geom2d_Curve) BWLProfile;
		Handle(Geom2d_Curve) StationLengthProfile;
		Handle(Geom2d_Curve) zBarProfile;

	};


	class Vessel_FormDim
		: public Vessel_FormDim_Params
		, public Vessel_FormDim_Profiles
	{
