...
namespace AutLib
{
	...
	inline tensor2 operator&(const diagTensor2& dt1, const tensor2& t2)
	{
		tensor2 result;
	...
	inline tensor2 operator&(const tensor2& t1, const diagTensor2& dt2)
	{
		tensor2 result;
	...
	inline tensor2 operator&(const sphericalTensor2& st1, const tensor2& t2)
	{
		tensor2 result;
	...
	inline tensor2 operator&(const tensor2& t1, const sphericalTensor2& st2)
	{
		tensor2 result;
	...
	inline vector2 operator&(const tensor2& t, const vector2& v)
	{
		vector2 result;
	...
	inline vector2 operator&(const vector2& v, const tensor2& t)
	{
		vector2 result;
	...
	inline tensor2 operator*(const vector2& v1, const vector2& v2)
	{
		tensor2 result;
