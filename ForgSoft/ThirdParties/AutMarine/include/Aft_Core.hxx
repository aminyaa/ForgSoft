...
namespace AutLib
{
	...
	template<class OptNodeAlg, class SizeFun, class FrontInfo, class FrontData, class MetricFun = void>
	class Aft_Core
		: public Aft_Core_Base<OptNodeAlg, FrontInfo, FrontData, SizeFun, MetricFun>
	{

	public:

		typedef Aft_Core_Base<OptNodeAlg, FrontInfo, FrontData, SizeFun, MetricFun>
			base;
	...
	class Aft_Core<OptNodeAlg, SizeFun, FrontInfo, FrontData, void>
		: public Aft_Core_Base<OptNodeAlg, FrontInfo, FrontData, SizeFun, void>
	{

	public:

		typedef Aft_Core_Base<OptNodeAlg, FrontInfo, FrontData, SizeFun, void>
			base;
