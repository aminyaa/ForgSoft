...
template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length>::TensorN()
{}

template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length>::TensorN(const VectorSpace<TensorN<Cmpt, length>, Cmpt, length*length>& vs)
	: VectorSpace<TensorN<Cmpt, length>, Cmpt, length*length>(vs)
{}

template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length>::TensorN(const Cmpt & tx)
{
	VectorSpaceOps<TensorN<Cmpt, length>::nComponents, 0>::eqOpS(*this, tx, eqOp<Cmpt>());
}

template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length>::TensorN(Istream & is)
	: VectorSpace<TensorN<Cmpt, length>, Cmpt, length*length>(is)
{}

template<class Cmpt, int length>
inline AutLib::direction AutLib::TensorN<Cmpt, length>::cmpt(const direction i, const direction j)
{
	if (i > TensorN<Cmpt, length>::rowLength - 1 || j > TensorN<Cmpt, length>::rowLength - 1)
	{
		FatalErrorIn
		(
...
{
	template<class Cmpt, int length>
	inline const Cmpt & TensorN<Cmpt, length>::operator()(const direction i, const direction j) const
	{
		return this->operator[](i*TensorN<Cmpt, length>::rowLength + j);
	}

	template<class Cmpt, int length>
	inline Cmpt & AutLib::TensorN<Cmpt, length>::operator()(const direction i, const direction j)
	{
		return this->operator[](i*TensorN<Cmpt, length>::rowLength + j);
	}
}
...
template<class Cmpt, int length>
inline AutLib::DiagTensorN<Cmpt, length> AutLib::TensorN<Cmpt, length>::diag() const
{
...
template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length> AutLib::TensorN<Cmpt, length>::T() const
{
...
template<class Cmpt, int length>
inline AutLib::TensorN<Cmpt, length> AutLib::TensorN<Cmpt, length>::negSumDiag() const
{
...
{
	template<class Cmpt, int length>
	inline void AutLib::TensorN<Cmpt, length>::operator=(const SphericalTensorN<Cmpt, length>& st)
	{
		label diag = 0;
	...
	template<class Cmpt, int length>
	inline void AutLib::TensorN<Cmpt, length>::operator=(const DiagTensorN<Cmpt, length>& dt)
	{
		label diag = 0;
		label k = 0;
		for (label i = 0; i < TensorN<Cmpt, length>::rowLength; i++)
...
namespace AutLib
{
	...
	template<class Cmpt, int length>
	inline TensorN<Cmpt, length> transform(const tensor& tt, const TensorN<Cmpt, length>& v)
	{
		return v;
	}
	...
	template <class Cmpt, int length>
	inline typename innerProduct<TensorN<Cmpt, length>, TensorN<Cmpt, length> >::type operator&(const TensorN<Cmpt, length>& t1, const TensorN<Cmpt, length>& t2)
	{
	...
	template <class Cmpt, int length>
	inline typename innerProduct<DiagTensorN<Cmpt, length>, TensorN<Cmpt, length> >::type operator& (const DiagTensorN<Cmpt, length>& dt1, const TensorN<Cmpt, length>& t2)
	{
	...
	template <class Cmpt, int length>
	inline typename innerProduct<TensorN<Cmpt, length>, DiagTensorN<Cmpt, length> >::type operator&(const TensorN<Cmpt, length>& t1, const DiagTensorN<Cmpt, length>& dt2)
	{
		TensorN<Cmpt, length> result;
	...
	template <class Cmpt, int length>
	inline typename innerProduct<SphericalTensorN<Cmpt, length>, TensorN<Cmpt, length> >::type operator&(const SphericalTensorN<Cmpt, length>& st1, const TensorN<Cmpt, length>& t2)
	{
	...
	template <class Cmpt, int length>
	inline typename innerProduct<TensorN<Cmpt, length>, SphericalTensorN<Cmpt, length> >::type operator&(const TensorN<Cmpt, length>& t1, const SphericalTensorN<Cmpt, length>& st2)
	{
	...
	template <class Cmpt, int length>
	inline typename innerProduct<TensorN<Cmpt, length>, VectorN<Cmpt, length> >::type operator&(const TensorN<Cmpt, length>& t, const VectorN<Cmpt, length>& v)
	{
	...
	template <class Cmpt, int length>
	inline typename innerProduct<VectorN<Cmpt, length>, TensorN<Cmpt, length> >::type operator&(const VectorN<Cmpt, length>& v, const TensorN<Cmpt, length>& t)
	{
		VectorN<Cmpt, length> result(VectorN<Cmpt, length>::zero);
	...
	template <class Cmpt, int length>
	inline typename outerProduct<VectorN<Cmpt, length>, VectorN<Cmpt, length> >::type operator*(const VectorN<Cmpt, length>& v1, const VectorN<Cmpt, length>& v2)
	{
		TensorN<Cmpt, length> result(TensorN<Cmpt, length>::zero);
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator+(const TensorN<Cmpt, length>& t1, const TensorN<Cmpt, length>& t2)
	{
		TensorN<Cmpt, length> res;
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator+(const TensorN<Cmpt, length>& t1, const DiagTensorN<Cmpt, length>& dt2)
	{
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator+(const DiagTensorN<Cmpt, length>& dt1, const TensorN<Cmpt, length>& t2)
	{
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator+(const TensorN<Cmpt, length>& t1, const SphericalTensorN<Cmpt, length>& st2)
	{
		TensorN<Cmpt, length> result(t1);
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator+(const SphericalTensorN<Cmpt, length>& st1, const TensorN<Cmpt, length>& t2)
	{
		TensorN<Cmpt, length> result(t2);
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> operator/(const scalar s, const TensorN<Cmpt, length>& t)
	{
		return s * inv(t);
	}
	...
	template <class Cmpt, int length>
	inline VectorN<Cmpt, length> operator/(const VectorN<Cmpt, length>& v, const TensorN<Cmpt, length>& t)
	{
		return v & inv(t);
	}
	...
	inline TensorN<Cmpt, length> inv(const TensorN<Cmpt, length>& t)
	{
		...
		for (label i = 0; i < length; i++)
		{
				...
				if (iPivot[j] != 1)
				{
					for (int k = 0; k < length; k++)
					{
						if (iPivot[k] == 0)
						{
							if
								(
								(temp = AutLib::mag(result[curRowOffset + k]))
									>= largestCoeff
									)
							{
								largestCoeff = temp;
			...
			if ((*srcIter) == Cmpt(0))
			{
				...
				) << "Singular tensor" << length << AutLib::abort(FatalError);
			}
	...
	template <class Cmpt, int length>
	inline TensorN<Cmpt, length> scaleRow(const TensorN<Cmpt, length>& t, const VectorN<Cmpt, length>& v)
	{
		TensorN<Cmpt, length> result;
