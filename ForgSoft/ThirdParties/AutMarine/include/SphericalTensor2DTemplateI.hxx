...
template<class Cmpt>
inline AutLib::SphericalTensor2D<Cmpt>::SphericalTensor2D()
{}

template<class Cmpt>
inline AutLib::SphericalTensor2D<Cmpt>::SphericalTensor2D(const VectorSpace<SphericalTensor2D<Cmpt>, Cmpt, 1>& vs)
	: VectorSpace<SphericalTensor2D<Cmpt>, Cmpt, 1>(vs)
{}

template<class Cmpt>
inline AutLib::SphericalTensor2D<Cmpt>::SphericalTensor2D(const Cmpt & stii)
{
	this->v_[II] = stii;
}

template<class Cmpt>
inline AutLib::SphericalTensor2D<Cmpt>::SphericalTensor2D(Istream & is)
	: VectorSpace<SphericalTensor2D<Cmpt>, Cmpt, 1>(is)
{}

template<class Cmpt>
inline const Cmpt & AutLib::SphericalTensor2D<Cmpt>::ii() const
{
	return this->v_[II];
}

template<class Cmpt>
inline Cmpt & AutLib::SphericalTensor2D<Cmpt>::ii()
{
	return this->v_[II];
}
...
namespace AutLib
{
	...
	template <class Cmpt>
	inline SphericalTensor2D<Cmpt> operator&(const SphericalTensor2D<Cmpt>& st1, const SphericalTensor2D<Cmpt>& st2)
	{
	...
	template <class Cmpt>
	inline Vector2D<Cmpt> operator&(const SphericalTensor2D<Cmpt>& st, const Vector2D<Cmpt>& v)
	{
	...
	template <class Cmpt>
	inline Vector2D<Cmpt> operator&(const Vector2D<Cmpt>& v, const SphericalTensor2D<Cmpt>& st)
	{
		return Vector2D<Cmpt>
			(
				v.x()*st.ii(),
	...
	template <class Cmpt>
	inline SphericalTensor2D<Cmpt> operator/(const scalar s, const SphericalTensor2D<Cmpt>& st)
	{
