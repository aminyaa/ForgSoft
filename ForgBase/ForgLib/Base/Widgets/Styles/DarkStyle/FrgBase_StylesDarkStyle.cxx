...
ForgBaseLib::FrgBase_StylesDarkStyle::FrgBase_StylesDarkStyle(QStyle* style)
	: QProxyStyle(style)
{

}

QStyle* ForgBaseLib::FrgBase_StylesDarkStyle::styleBase(QStyle* style) const
{
	static QStyle* base =
...
QStyle* ForgBaseLib::FrgBase_StylesDarkStyle::baseStyle() const
{
	return styleBase();
}

void ForgBaseLib::FrgBase_StylesDarkStyle::polish(QPalette& palette)
{
...
void ForgBaseLib::FrgBase_StylesDarkStyle::polish(QApplication* app)
{
	if (!app) return;
