...
set_target_properties(vtkParallelMPI PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkParallelMPI-8.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "vtkCommonDataModel"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkParallelMPI-8.2.dll"
  )
...
set_target_properties(vtkFiltersParallelMPI PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkFiltersParallelMPI-8.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkFiltersParallelMPI-8.2.dll"
  )
...
# Import target "vtkDomainsParallelChemistry" for configuration "Release"
set_property(TARGET vtkDomainsParallelChemistry APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(vtkDomainsParallelChemistry PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkDomainsParallelChemistry-8.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "vtkCommonCore;vtkParallelMPI;vtkFiltersParallelMPI"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkDomainsParallelChemistry-8.2.dll"
  )
...
set_target_properties(vtkFiltersParallelGeometry PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkFiltersParallelGeometry-8.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkFiltersParallelGeometry-8.2.dll"
  )
...
set_target_properties(vtkFiltersParallelVerdict PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkFiltersParallelVerdict-8.2.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkFiltersParallelVerdict-8.2.dll"
  )
...
set_target_properties(vtkViewsGeovis PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkViewsGeovis-8.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "vtkCommonCore;vtkGeovisCore;vtkInfovisLayout;vtkInteractionStyle;vtkRenderingCore;vtkViewsCore"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkViewsGeovis-8.2.dll"
  )
...
set_target_properties(vtkIOMPIImage PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkIOMPIImage-8.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkIOMPIImage-8.2.dll"
  )
...
set_target_properties(vtkIOMPIParallel PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkIOMPIParallel-8.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkIOMPIParallel-8.2.dll"
  )
...
set_target_properties(vtkIOParallelNetCDF PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkIOParallelNetCDF-8.2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "vtkCommonCore;vtkCommonDataModel;vtkParallelMPI;vtknetcdf"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkIOParallelNetCDF-8.2.dll"
  )
