...
ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FrgMarine_TItemGeomParMdls_Preview
(
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::UpdatePreviewSlot()
{
	if (theModelEntity_)
	{
		ShowTabWidget();
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FormFastDiscreteParams()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::ConnectVrntsToSlots()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::DisconnectVrntsToSlots()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscAngleValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscDeflectionValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscMinSizeValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscInParallelValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscRelativeValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscAdaptiveMinValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscInternalVerticesModeMinValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::FDiscControlSurfaceDeflectionMinValueChangedSlot()
{
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::TItemNameToTabTitleChangedSlot(const QString & title)
{
	auto myMainWindow = dynamic_cast<FrgMarine_MainWindow*>(GetParentMainWindow());
	if (myMainWindow)
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::ShowTabWidget()
{
	auto myMainWindow = dynamic_cast<FrgMarine_MainWindow*>(GetParentMainWindow());
	if (myMainWindow)
...
void ForgMarineLib::FrgMarine_TItemGeomParMdls_Preview::TItemDoubleClickedSlot()
{
	ShowTabWidget();
}