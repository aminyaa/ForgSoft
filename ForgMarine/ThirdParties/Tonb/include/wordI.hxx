...
inline const tnbLib::word& tnbLib::word::operator=(const word& q)
{
	string::operator=(q);
	return *this;
}
...
inline const tnbLib::word& tnbLib::word::operator=(const string& q)
{
	string::operator=(q);
	stripInvalid();
	return *this;
...
inline const tnbLib::word& tnbLib::word::operator=(const std::string& q)
{
	string::operator=(q);
	stripInvalid();
	return *this;
...
inline const tnbLib::word& tnbLib::word::operator=(const char* q)
{
	string::operator=(q);
	stripInvalid();
	return *this;
