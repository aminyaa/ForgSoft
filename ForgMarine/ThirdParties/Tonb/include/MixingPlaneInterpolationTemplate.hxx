...
namespace tnbLib
{
		...
		public MixingPlaneInterpolationName
	{
		...
		typedef std::map<tnbLib::scalar, std::list<tnbLib::point> > profileHistogram;
...
#ifdef NoRepository
#   include <MixingPlaneInterpolationTemplate.cxx>
#   include <MixingPlaneProfile.cxx>
#   include <MixingPlaneInterpolationPatches.cxx>
#   include <MixingPlaneInterpolationAddressing.cxx>
#   include <MixingPlaneInterpolate.cxx>
#endif
