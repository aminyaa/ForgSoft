...
\*---------------------------------------------------------------------------*/
#ifndef _extendedLduAddressing_Header
#define _extendedLduAddressing_Header
...
namespace tnbLib
{
	...
	/*---------------------------------------------------------------------------*\
					   Class extendedLduAddressing Declaration
	\*---------------------------------------------------------------------------*/
...
#endif // !_extendedLduAddressing_Header
