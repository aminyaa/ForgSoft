...
\*---------------------------------------------------------------------------*/
#ifndef _BlockILUCpPrecon_Header
#define _BlockILUCpPrecon_Header

#include <BlockLduPrecon.hxx>
#include <extendedBlockLduMatrices.hxx>
...
namespace tnbLib
{
	...
	/*---------------------------------------------------------------------------*\
						  Class BlockILUCpPrecon Declaration
	\*---------------------------------------------------------------------------*/
...
#ifdef NoRepository
#   include <BlockILUCpPrecon.cxx>
#   include <BlockILUCpPreconDecoupled.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_BlockILUCpPrecon_Header
