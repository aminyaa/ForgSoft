...
namespace tnbLib
{
	...
	template <class Cmpt>
	DiagTensor<Cmpt>::DiagTensor(Istream& is)
	...
	template <class Cmpt>
	const Cmpt&  DiagTensor<Cmpt>::xx() const
	{
		return this->v_[XX];
	}

	template <class Cmpt>
	const Cmpt&  DiagTensor<Cmpt>::yy() const
	{
		return this->v_[YY];
	}

	template <class Cmpt>
	const Cmpt&  DiagTensor<Cmpt>::zz() const
	{
		return this->v_[ZZ];
	}
	...
	template <class Cmpt>
	Cmpt& DiagTensor<Cmpt>::xx()
	{
		return this->v_[XX];
	}

	template <class Cmpt>
	Cmpt& DiagTensor<Cmpt>::yy()
	{
		return this->v_[YY];
	}

	template <class Cmpt>
	Cmpt& DiagTensor<Cmpt>::zz()
	{
		return this->v_[ZZ];
	}
