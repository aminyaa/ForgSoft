...
\*---------------------------------------------------------------------------*/
#ifndef _profiling_Header
#define _profiling_Header
...
#define addProfile(name) tnbLib::profilingTrigger profileTriggerFor##name (#name)

// Use this if a description with spaces, colons etc should be added
#define addProfile2(name,descr) tnbLib::profilingTrigger profileTriggerFor##name (descr)
