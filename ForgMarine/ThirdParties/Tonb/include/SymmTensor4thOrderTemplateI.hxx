...
namespace tnbLib
{
	...
	// Construct null
	template<class Cmpt>
	SymmTensor4thOrder<Cmpt>::SymmTensor4thOrder()
	{}
	...
	template<class Cmpt>
	SymmTensor4thOrder<Cmpt>::SymmTensor4thOrder(Istream& is)
	...
	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::xxxx() const
	{
		return this->v_[XXXX];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::xxyy() const
	{
		return this->v_[XXYY];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::xxzz() const
	{
		return this->v_[XXZZ];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::yyyy() const
	{
		return this->v_[YYYY];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::yyzz() const
	{
		return this->v_[YYZZ];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::zzzz() const
	{
		return this->v_[ZZZZ];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::xyxy() const
	{
		return this->v_[XYXY];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::yzyz() const
	{
		return this->v_[YZYZ];
	}

	template<class Cmpt>
	const Cmpt&  SymmTensor4thOrder<Cmpt>::zxzx() const
	{
		return this->v_[ZXZX];
	}
	...
	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::xxxx()
	{
		return this->v_[XXXX];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::xxyy()
	{
		return this->v_[XXYY];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::xxzz()
	{
		return this->v_[XXZZ];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::yyyy()
	{
		return this->v_[YYYY];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::yyzz()
	{
		return this->v_[YYZZ];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::zzzz()
	{
		return this->v_[ZZZZ];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::xyxy()
	{
		return this->v_[XYXY];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::yzyz()
	{
		return this->v_[YZYZ];
	}

	template<class Cmpt>
	Cmpt& SymmTensor4thOrder<Cmpt>::zxzx()
	{
		return this->v_[ZXZX];
	}
