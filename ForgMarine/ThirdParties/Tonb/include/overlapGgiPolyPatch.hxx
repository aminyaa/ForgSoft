...
\*---------------------------------------------------------------------------*/
#ifndef _overlapGgiPolyPatch_Header
#define _overlapGgiPolyPatch_Header

#include <coupledPolyPatch.hxx>
#include <standAlonePatch.hxx>
#include <overlapGgiInterpolation.hxx>
...
#ifdef NoRepository
#   include <overlapGgiPolyPatchTemplates.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_overlapGgiPolyPatch_Header
