...
\*---------------------------------------------------------------------------*/
#ifndef _extendedLduMatrix_Header
#define _extendedLduMatrix_Header
...
namespace tnbLib
{
	...
	/*---------------------------------------------------------------------------*\
						  Class extendedLduMatrix Declaration
	\*---------------------------------------------------------------------------*/
...
#endif // !_extendedLduMatrix_Header
