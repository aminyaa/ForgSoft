...
bool tnbLib::string::valid(const string& str)
{
...
template<class String>
bool tnbLib::string::stripInvalid(string& str)
{
	if (!valid<String>(str))
	{
...
template<class String>
bool tnbLib::string::meta(const string& str, const char quote)
{
	int escaped = 0;
	for (const_iterator iter = str.begin(); iter != str.end(); iter++)
	{
...
template<class String>
String tnbLib::string::validate(const string& str)
{
	string ss = str;
