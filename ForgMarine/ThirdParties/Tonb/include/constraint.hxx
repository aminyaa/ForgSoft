...
\*---------------------------------------------------------------------------*/
#ifndef _constraint_Header
#define _constraint_Header
...
#ifdef NoRepository
#    include <constraint.cxx>
#    include <constraintTools.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#include <scalarConstraint.hxx>

#endif // !_constraint_Header
