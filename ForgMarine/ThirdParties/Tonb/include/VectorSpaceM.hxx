#pragma once
#ifndef _VectorSpaceM_Header
#define _VectorSpaceM_Header
...
public:
	...
	static void opVV(V& vs, const V1& vs1, const V2& vs2, Op o)
	{
		vs.v_[I] = o(vs1.v_[I], vs2.v_[I]);
	...
	static void SopEqOpVV(S& s, const V1& vs1, const V2& vs2, EqOp eo, Op o)
	{
