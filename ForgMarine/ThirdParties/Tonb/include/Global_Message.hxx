...
#define SEND_MESSAGE tnbLib::gl_messenger->SendMessage()

#define SEND_INFO tnbLib::gl_messenger->SendInfo(SEND_MESSAGE);
#define SEND_WARNING tnbLib::gl_messenger->SendWarning(SEND_MESSAGE);
#define SEND_ERROR tnbLib::gl_messenger->SendError(SEND_MESSAGE);
