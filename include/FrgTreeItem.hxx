...
class FORGBASE_EXPORT FrgTreeItem : public QTreeWidgetItem
{
...
public:
	...
	FrgTreeItem(const FrgString& itemName, FrgTreeItem* parentItem = FrgNullPtr, FrgTree* parentTree = FrgNullPtr, FrgMainWindow* parentMainWindow = FrgNullPtr);
